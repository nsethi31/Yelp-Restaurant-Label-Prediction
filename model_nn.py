...
#Train.csv
def clean_train():
    train = pd.read_csv('../data/train_id.csv')
...
train_to_biz = pd.read_csv('../data/train_labels.csv')

uni_bus = train_to_biz['business_id'].unique()

blend1 = np.load('../data/Model1_Full.npy')

blend2 = np.load('../data/Model2_Full_2.npy')

blend3 = np.load('../data/Model2_Full_3.npy')

blend4 = np.load('../data/Model2_Full_4.npy')

blend5 = np.load('../data/Model2_Full_5.npy')
...
if(submit):
    ...
    test_to_biz = pd.read_csv('../data/test_labels.csv')
    
    uni_bus = test_to_biz['business_id'].unique()
        
    blend1 = np.load('../data/Model1_Full_result.npy')
    
    blend2 = np.load('../data/Model2_Full_2_result.npy')
    
    blend3 = np.load('../data/Model2_Full_3_result.npy')
    
    blend4 = np.load('../data/Model2_Full_4_result.npy')
    
    blend5 = np.load('../data/Model2_Full_5_result.npy')
    ...
    x1.to_csv('../data/result.csv',index=0)
